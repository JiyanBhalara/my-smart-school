...
export default function QuizCard({ quiz, lessonId, index, userId, userRole }: QuizCardProps) {
  // Safety check for attempts array
  ...
  return (
    <div className="group bg-white border border-gray-200 rounded-2xl overflow-hidden hover:shadow-2xl hover:border-[#219EBC]/50 transition-all duration-500 transform hover:-translate-y-2 hover:scale-[1.02]">
      {/* Top decorative border */}
      <div className="h-1 w-full bg-gradient-to-r from-[#219EBC] via-[#0077B6] to-[#023047] opacity-60 group-hover:opacity-100 transition-opacity duration-300"></div>
      ...
      <div className="relative p-4 sm:p-6 lg:p-8">
        {/* Header Section with Number Badge, Title, and Author Actions */}
        <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-4 mb-6">
          {/* Left: Quiz Number Badge + Title/Description */}
          <div className="flex items-start gap-4 flex-1">
            ...
            <div className="flex-1">
              <h3 className="text-lg sm:text-xl lg:text-2xl font-bold text-gray-900 group-hover:text-[#023047] transition-colors leading-tight mb-2">
                {quiz.title}
              </h3>
              {quiz.description && (
          ...
          {/* Right: Status Badge + Author Actions */}
        ...
        {/* Score Section */}
        {latestAttempt && (
          <div className={`mb-6 p-4 sm:p-6 rounded-2xl border-2 shadow-sm hover:shadow-md transition-all duration-300 ${getScoreBgColor(latestAttempt.percentage, latestAttempt.passed)}`}>
        ...
        {!latestAttempt && maxAttempts !== Infinity && (
          <div className="mb-6 p-4 bg-gradient-to-r from-gray-50 to-blue-50 rounded-2xl border border-gray-200 shadow-sm">
            <div className="flex items-center gap-3">
      ...
      {/* Bottom decoration */}
      <div className="h-1 bg-gradient-to-r from-transparent via-[#219EBC]/20 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
    </div>
  );
}
