      ...
      <div className="min-h-screen bg-[#edf2f5] pt-20">
        <div className="max-w-6xl mx-auto px-4 py-8">
          <div className="flex items-center justify-center">
            ...
            <span className="ml-2 text-graphite">Loading teachers...</span>
          </div>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-[#edf2f5] pt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-8">
        ...
        <div className="mb-6 lg:mb-8">
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-ink mb-2">Teacher Directory</h1>
          <p className="text-sm sm:text-base text-graphite">Connect and chat with your teachers</p>
        </div>
                ...
                >
                  ...
                  <div className="flex items-center mb-4">
                    {teacher.image ? (
                      ...
                      <div className="w-10 h-10 sm:w-12 sm:h-12 bg-ink rounded-full flex items-center justify-center flex-shrink-0">
                    ...
                    <div className="ml-3 flex-1 min-w-0">
                      ...
                      <p className="text-xs sm:text-sm text-graphite truncate">{teacher.email}</p>
                    </div>
                  </div>
